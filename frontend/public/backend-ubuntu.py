#!/usr/bin/env python3
"""
Private Document Summarizer - Backend for Ubuntu/Linux
=======================================================
Complete privacy-focused document summarization using local Ollama models.

Prerequisites:
1. Install Ollama: curl -fsSL https://ollama.com/install.sh | sh
2. Python 3.10+: sudo apt install python3 python3-pip
...
5. Make executable: chmod +x backend-ubuntu.py
6. Run: python3 backend-ubuntu.py
...
def start_ollama_ubuntu():
    """Start Ollama service on Ubuntu/Linux"""
    ...
    try:
        ...
        print("⚠️ Ollama didn't start automatically. Please start it manually with: ollama serve")
        return False
...
@app.get("/")
def home():
    return {"message": "Private Document Summarizer API - Ubuntu/Linux", "status": "active"}
...
if __name__ == "__main__":
    print("=" * 60)
    print("🔒 Private Document Summarizer - Ubuntu/Linux Backend")
    print("=" * 60)
