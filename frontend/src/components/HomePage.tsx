    ...
    <main className="w-full flex-1 flex flex-col items-center justify-center bg-background relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="flex flex-col items-start gap-6">
            ...
            <div className="flex items-center gap-3 mb-2">
              <img src="/logo.png" alt="Docu" className="w-12 h-12" />
              <span className="text-4xl font-bold">Docu</span>
            </div>
            ...
            <p className="max-w-xl text-pretty text-base text-muted-foreground md:text-lg">
              A privacy-first RAG assistant that runs entirely locally
              using Ollama. No cloud uploads, no external APIs, no data leaks.
              Everything processes on your own hardware with open-source AI
              models you control.
            </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    All AI runs on your machine via Ollama. Zero cloud
                    dependencies.
                  </p>
                </div>
              </div>
      ...
      >
        <div className="mb-8 max-w-xl">
          ...
          <p className="text-muted-foreground">
            Sign in to start processing documents locally on your machine. All
            processing stays private.
          </p>
        </div>
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-3">
                <Dialog>
                  <DialogTrigger asChild>
                    <Button
                      size="lg"
                      className="flex-1 font-semibold px-4 py-3 bg-black text-white dark:bg-white dark:text-black"
                    >
                      Sign In
                    </Button>
                  </DialogTrigger>
          ...
          <Card className="p-4 mb-0">
            ...
            <CardContent className="text-sm text-muted-foreground grid gap-3 mb-0">
              ...
              <div className="flex items-start gap-2">
                ...
                <p className="m-0">
                  Works without internet. Perfect for sensitive or confidential
                  documents.
                </p>
              </div>
              <div className="flex items-start gap-2">
                ...
                <p className="m-0">
                  Uses Ollama with models like Mistral, Llama. Fully transparent
                  AI.
                </p>
              </div>
              <div className="flex items-start gap-2">
                ...
                <p className="m-0">
                  No API costs. No per-document fees. Unlimited processing on
                  your machine.
                </p>
              </div>
              <div className="flex items-start gap-2">
                ...
                <p className="m-0">
                  You own the models, data, and infrastructure. No vendor
                  lock-in.
                </p>
              </div>
              <div className="flex items-start gap-2">
      ...
      >
        <div className="mb-6 max-w-xl">
          ...
          <p className="text-muted-foreground">
            Why local processing solves real problems better than cloud
            solutions.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          >
            <AccordionItem value="item-1">
              <AccordionTrigger className="rounded-md border px-4 py-3 text-left">
              ...
              <AccordionContent className="text-sm text-muted-foreground p-4 border-x border-b rounded-b-md">
                We use Ollama to run open-source AI models (Mistral, Llama, Phi,
                etc.) directly on your machine. Documents are processed entirely
                locally with no cloud uploads. The AI runs on your CPU/GPU using
            ...
            <AccordionItem value="item-2">
              ...
              <AccordionContent className="text-sm text-muted-foreground p-4 border-x border-b rounded-b-md">
                A multi-stage verification pass checks entities and claims
                against the source document, with optional knowledge graph
                integration to validate facts. We also use confidence scoring
                and uncertainty quantification to flag potentially unreliable
                content before final output.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-3">
              ...
              <AccordionContent className="text-sm text-muted-foreground p-4 border-x border-b rounded-b-md">
                Processing times vary by document length and complexity. Typical
                documents (10-50 pages) are summarized in 10-30 seconds. Very
                long documents (100+ pages) may take 2-5 minutes due to thorough
            ...
            <AccordionItem value="item-4">
              ...
              <AccordionContent className="text-sm text-muted-foreground p-4 border-x border-b rounded-b-md">
                We support PDF, Word (.docx), plain text, HTML, Markdown, and
                structured formats like JSON/XML. Image files are not
                summarized, but you can attach images in chat and ask questions
                about them.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
          ...
          >
            <AccordionItem value="item-5">
              ...
              <AccordionContent className="text-sm text-muted-foreground p-4 border-x border-b rounded-b-md">
                Partially. Document summarization is text-only. For images, you
                can attach them in chat and ask questions (Q&A) about the
                content. Audio/video transcripts can be summarized if provided
                as text.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-6">
              ...
              <AccordionContent className="text-sm text-muted-foreground p-4 border-x border-b rounded-b-md">
                We apply multi-criteria evaluation beyond n-gram overlap,
                measuring semantics, faithfulness, coherence, and completeness.
                Hybrid Human-AI reviews are supported, with A/B testing
                capabilities for comparing different summarization approaches.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-7">
              ...
              <AccordionContent className="text-sm text-muted-foreground p-4 border-x border-b rounded-b-md">
                Yes, we provide RESTful APIs with comprehensive documentation,
                SDKs for popular languages (Python, JavaScript, Java), webhook
                support for async processing, and batch processing capabilities
            ...
            <AccordionItem value="item-8">
              ...
              <AccordionContent className="text-sm text-muted-foreground p-4 border-x border-b rounded-b-md">
                All documents are encrypted in transit and at rest using
                AES-256. We offer on-premise deployment options, GDPR
                compliance, and data retention policies. Documents are never
                stored longer than necessary for processing.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
