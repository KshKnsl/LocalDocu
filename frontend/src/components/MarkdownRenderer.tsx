  ...
  const components = useMemo(() => {
    return {
      ...
      h1: ({ node, children, ...props }: any) => (
        <h1 className="text-2xl font-bold mt-6 mb-2 scroll-mt-20" {...props}>
          {children}
        </h1>
      ),
      h2: ({ node, children, ...props }: any) => (
        <h2 className="text-xl font-bold mt-5 mb-2 scroll-mt-20" {...props}>
          {children}
        </h2>
      ),
      h3: ({ node, children, ...props }: any) => (
        <h3 className="text-lg font-bold mt-4 mb-2 scroll-mt-20" {...props}>
          {children}
        </h3>
      ),
      h4: ({ node, children, ...props }: any) => (
        <h4 className="text-base font-bold mt-3 mb-1 scroll-mt-20" {...props}>
          {children}
        </h4>
      ),
      ...
      code: ({ node, className, children, ...props }: any) => {
        ...
        if (isInline) {
          return (
            <code className="bg-muted px-1.5 py-0.5 rounded text-xs font-mono before:content-none after:content-none" {...props}>
              {children}
            </code>
          );
        }
